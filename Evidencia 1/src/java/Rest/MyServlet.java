...
public class MyServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String i = Rest.RestServlet.a;
            String f = Rest.RestServlet.b;
            if(!(i == null ? a == null : i.equals(a))){
                ...
                out.println("<a href=\"Usuario.jsp\">ok</a>");
                out.println("</body>");
                out.println("</html>");
            }else{
                if(b == null ? f == null : b.equals(f)){
                    ...
                    out.println("<a href=\"encuesta.jsp\">Calcular IMC</a>");
                    out.println("</body>");
                    out.println("</html>");
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h1> Contrasena incorrecta </h1>");
                out.println("<a href=\"Usuario.jsp\">ok</a>");
                out.println("</body>");
                out.println("</html>"); 
                }
